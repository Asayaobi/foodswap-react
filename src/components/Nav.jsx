      ...
      <div className="absolute inset-0 grid grid-cols-2 gap-10 justify-between content-start mr-20 ml-14">
        ...
        <div className="gap-4 flex justify-end">
          {isLoggedIn ? (
            <>
              <Link to="/listings">
                <button className=" w-32 h-10 items-center font-bold text-white text-xs md:text-base my-10 hover:border border-white">
                  My Dish
                </button>
              </Link>
              <Link to="/bookings">
              ...
              <button
                onClick={logout}
                className="w-32 h-10 items-center font-bold text-white text-xs md:text-base my-10 hover:border border-white"
              >
                Log Out
              </button>
            </>
